# Copyright (c) Digital Trust Centre, Nanyang Technological University
...
VERSION_FILE = os.path.abspath('audio_deepfake_detection/version.py')
...
if __name__ == '__main__':
    ...
    setup(
        ...
        description='Audio Deepfake Detection Eval: Evaluation Framework for Audio Deepfake Detection',
        long_description=readme(),
        long_description_content_type='text/markdown',
        # github url to be added
        url='https://github.com/cyaaronk',
